...
### 步骤 2.3: 精简 layout-data-provider.ts（渐进式迁移进行中）
...
| 2.3.d 开始使用 diag | ✅ 已完成 | trustedHeightUsedCount, signatureMatchedCount 已迁移 |
| 2.3.e 继续迁移 | ⏳ 可选后续 | 其他计数器可后续继续迁移 |
| 2.3.f 编译验证 | ✅ 已完成 | `npm run build && npm test` 通过 (36个测试) |
